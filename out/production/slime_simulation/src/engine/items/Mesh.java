...
public class Mesh {
     ...
     */
    public Mesh(float[] positions, float[] textCords, int[] indices) {
        this(positions, textCords, new float[0], new float[0], new float[0], new int[0], new float[0], indices);
    }
    ...
    private void initRender() {
        engine.items.Texture texture = material.getTexture();
        if(texture != null){
        ...
        engine.items.Texture normalMap = material.getNormalMap();
        if(normalMap != null) {
